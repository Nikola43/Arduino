...
void displayText(){ //opens and displays a rolling text file on the SmartGPU Screen
  ...
  lcd.stringSD(0,200,319,210,WHITE,FONT3,FILL,pos++,MESSAGELETTERS,"Text"); //display 30 characters long
  
  delay(10); //delay that sets the message speed
  
  if(pos > (MESSAGE + MESSAGELETTERS)){ //if pos is bigger than the last valid start reading file position
    pos=0;
  }  
}
